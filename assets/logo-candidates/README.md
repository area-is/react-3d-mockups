...
same greens as the current dual-slant "A" (`../area-a-dual-slant-green.svg`), so
...
| [`stack.svg`](stack.svg) | Abstract | Three flat screens stacked and receding into shadow: "mockups", plural, layered. |
