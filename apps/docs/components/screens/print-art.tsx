  ...
  return (
    ...
    >
      <div style={{ border: '1px solid #b89b5e', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '36px 20px 28px' }}>
        ...
        <div style={{ fontSize: 44, lineHeight: 1.15, fontWeight: 500, margin: '26px 0 0', color: '#e8dcc0' }}>
...
export function BrochureFrontArt() {
  return (
    ...
    >
      ...
      <div style={{ fontSize: 34, lineHeight: 1.05, margin: '14px 0 8px', fontWeight: 700, color: '#f0ead6' }}>
        Trail Guide
      </div>
