...
export const DEVICES = [
  ...
  device('iphone-18-pro', 'iPhone 18 Pro', 'IPhoneMockup', '18pro', 'device=iphone&pvariant=18pro&color=burgundy&ry=-24'),
  device('iphone-18-pro-max', 'iPhone 18 Pro Max', 'IPhoneMockup', '18promax', 'device=iphone&pvariant=18promax&color=glacier&ry=-24'),
  device('iphone-duo', 'iPhone Duo', 'IPhoneDuoMockup', 'duo', 'device=iphoneduo&openAngle=150&color=nightsky&ry=-20'),
  ...
  device('macbook-neo-13', 'MacBook Neo 13″', 'LaptopMockup', 'neo13', 'device=laptop&lvariant=neo13&color=indigo&ry=-18'),
  ...
  device('apple-watch-series-11', 'Apple Watch Series 11', 'AppleWatchMockup', 'series11', 'device=watch&wvariant=series11&color=jetblack&ry=-18'),
  device('apple-watch-series-12', 'Apple Watch Series 12', 'AppleWatchMockup', 'series12', 'device=watch&wvariant=series12&color=darkbronze&ry=-18'),
  device('apple-watch-ultra-4', 'Apple Watch Ultra 4', 'AppleWatchMockup', 'ultra4', 'device=watch&wvariant=ultra4&color=black&ry=-18'),
